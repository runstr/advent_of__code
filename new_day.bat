...
mkdir Day%arg1%
if %arg1% gtr 10 ( copy Day10\* Day%arg1%\) ELSE (copy Day1\* Day%arg1%\)

cd Day%arg1%
break>input.txt
break>test_input.txt
echo __all__ = ["day%arg1%_1", "day%arg1%_2"]>__init__.py
if (%arg1% gtr 10) ( ren day10_1.py day%arg1%_1.py & ren day10_2.py day%arg1%_2.py) ELSE (ren day1_1.py day%arg1%_1.py & ren day1_2.py day%arg1%_2.py)
